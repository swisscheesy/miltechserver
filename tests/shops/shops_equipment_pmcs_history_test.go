...
func TestGetEquipmentPmcsHistoryRepositoryIncludesGuideAndCustom(t *testing.T) {
	...
	require.NotNil(t, withHistory.HistoricalPmcs[0].PerformedBy)
	require.Equal(t, customUserID, *withHistory.HistoricalPmcs[0].PerformedBy)
	require.NotNil(t, withHistory.HistoricalPmcs[0].PerformedByUsername)
	...
	require.NotNil(t, withHistory.HistoricalPmcs[1].GuideManual)
	...
	require.NotNil(t, withHistory.HistoricalPmcs[1].PerformedBy)
	require.Equal(t, historyUserID, *withHistory.HistoricalPmcs[1].PerformedBy)
	require.NotNil(t, withHistory.HistoricalPmcs[1].PerformedByUsername)
