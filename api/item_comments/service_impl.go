...
func mapCommentWithAuthor(comment CommentWithAuthor) CommentResponse {
	authorName := "Unknown"
...
func mapCommentToResponse(comment model.ItemComments, authorName string) CommentResponse {
	var parentID *string
